...
class MetricsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Publish = channel.unary_unary(
                '/services.Metrics/Publish',
                request_serializer=metrics__pb2.Metric.SerializeToString,
                response_deserializer=metrics__pb2.PublishReply.FromString,
...
def add_MetricsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Publish': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=metrics__pb2.PublishReply.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'services.Metrics', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('services.Metrics', rpc_method_handlers)
...
class Metrics(object):
    ...
    def Publish(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            metrics__pb2.PublishReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
