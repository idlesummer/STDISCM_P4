        ...
        <Tabs defaultValue="overview">
          <div className="mb-6 border-b border-gray-200">
            <TabsList className="h-auto gap-8 rounded-none border-none bg-transparent p-0">
              <TabsTrigger
                value="overview"
                className="rounded-none border-0 border-b-2 border-transparent bg-transparent px-0 pb-3 pt-0 text-sm font-medium text-gray-500 shadow-none transition-colors hover:text-gray-700 data-[state=active]:border-gray-900 data-[state=active]:bg-transparent data-[state=active]:text-gray-900 data-[state=active]:shadow-none"
              >
                Overview
              </TabsTrigger>
              <TabsTrigger
